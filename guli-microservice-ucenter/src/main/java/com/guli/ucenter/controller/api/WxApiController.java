...
public class WxApiController {
    ...
    public String genQrConnect(HttpSession session) {
        ...
        String state = "marvellzh";//为了让大家能够使用微信回调跳转服务器，这里填写你在ngrok的前置域名
    ...
    public String callback(String code, String state, HttpSession session) {
        ...
        // 登录
//      //生成jwt
        String guliJwtToken = com.atguigu.jwt.util.JwtUtils.generateJWT(member);
    ...
    public R getLoginInfoByJwtToken(@RequestBody String jwtToken){
        ...
        Claims claims = com.atguigu.jwt.util.JwtUtils.checkJWT(jwtToken);
